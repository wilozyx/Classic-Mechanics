...
scoreboard objectives add CM_IsOldTntOnExtremeties dummy
...
scoreboard players set CM.global CM_SeedTilling 1
#scoreboard players set CM.global CM_NoItemNames 1
#scoreboard players set CM.global CM_NoItemNamesContainers 1
scoreboard players set CM.global CM_NoCartSounds 1
scoreboard players set CM.global CM_NoBoatSounds 1
scoreboard players set CM.global CM_OldDebugHUD 1
scoreboard players set CM.global CM_PunchSheepWool 1
scoreboard players set CM.global CM_OldTNT 1
scoreboard players set CM.global CM_NoSeedGrassDrops 1
scoreboard players set CM.global CM_NoSquidDespawning 1
...
scoreboard players set CM.global CM_OldDurabilityModernTools 1
scoreboard players set CM.global CM_DisableSleep 1
...
scoreboard players set CM.global CM_NoOldWolfSpawns 1
scoreboard players set CM.global CM_NoWolves 1
scoreboard players set CM.global CM_NoWeather 1
...
scoreboard players set CM.global CM_OldBowBlockInteractions 1
...
scoreboard players set CM.global CM_NoSkeletonBoneDrops 1
...
function classic_mechanics:mechanics_modules/no_weather
...
function classic_mechanics:mechanics_modules/minecart_boosters/minecart_boosters
