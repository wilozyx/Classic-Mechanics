...
scoreboard players set CM.global CM_PreLoadedItems 2
...
data merge storage classic_mechanics:pre_loaded_items \
    ...
    "slot_4_max_count":"64",\
    \
    "slot_5_item":"oak_leaves",\
    "slot_5_count":"1",\
    "slot_5_max_count":"64",\
    \
    "slot_6_item":"oak_sapling",\
    "slot_6_count":"1",\
    "slot_6_max_count":"64",\
    \
    "slot_7_item":"dandelion",\
    "slot_7_count":"1",\
    "slot_7_max_count":"64",\
    \
    "slot_8_item":"poppy",\
...
# -> Module message
data modify storage classic_mechanics:options module_name set value "preloaded items (C0.0.20)"
