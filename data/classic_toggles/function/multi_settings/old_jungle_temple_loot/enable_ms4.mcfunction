scoreboard players set CM.global CM_OldJungleTempleLoot 4

# -> Module message
data modify storage classic_mechanics:options module_name set value "old jungle temple chest loot (R1.14)"
