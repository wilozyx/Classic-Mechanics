...
scoreboard players set CM.global CM_OldGappleEarlyRelease 1
scoreboard players set CM.global CM_OldGappleEarlyMidRelease 0


tellraw @s ["",{"text":"\u261e ","color":"green"},{"text":"Enabled old golden apple (early release)","bold":true,"color":"green"},{"text":"!","color":"green"}]
