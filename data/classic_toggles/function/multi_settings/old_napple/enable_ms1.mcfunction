...
scoreboard players set CM.global CM_OldNappleEarlyRelease 1
scoreboard players set CM.global CM_OldNappleEarlyMidRelease 0


tellraw @s ["",{"text":"\u261e ","color":"green"},{"text":"Enabled old enchanted golden apple (early release)","bold":true,"color":"green"},{"text":"!","color":"green"}]
