scoreboard players set CM.global CM_OldSheepSpawnColors 2

function classic_mechanics:mobs_modules/old_sheep_spawn_colors/old_sheep_spawn_colors

# -> Module message
data modify storage classic_mechanics:options module_name set value "old sheep spawn colors (B1.2)"
