scoreboard players set CM.global CM_OldMineshaftLoot 5

# -> Module message
data modify storage classic_mechanics:options module_name set value "old mineshaft chest loot (R1.17)"
