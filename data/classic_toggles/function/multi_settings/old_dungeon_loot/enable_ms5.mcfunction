scoreboard players set CM.global CM_OldDungeonLoot 5

tellraw @s ["",{"text":"\u261e ","color":"green"},{"text":"Enabled old dungeon chest loot (R1.6.1)","bold":true,"color":"green"},{"text":"!","color":"green"}]
