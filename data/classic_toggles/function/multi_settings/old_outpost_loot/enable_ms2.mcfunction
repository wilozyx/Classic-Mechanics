scoreboard players set CM.global CM_OldOutpostLoot 2

tellraw @s ["",{"text":"\u261e ","color":"green"},{"text":"Enabled old outpost chest loot (R1.19)","bold":true,"color":"green"},{"text":"!","color":"green"}]
