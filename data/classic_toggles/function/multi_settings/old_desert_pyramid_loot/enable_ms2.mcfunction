scoreboard players set CM.global CM_OldDesertPyramidLoot 2

# -> Module message
data modify storage classic_mechanics:options module_name set value "old desert pyramid chest loot (R1.4.6)"
