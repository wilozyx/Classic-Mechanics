...
scoreboard players set CM.global CM_OldVillagers 10

tellraw @s ["",{"text":"\u261e ","color":"green"},{"text":"Enabled old villagers (R1.14.4)","bold":true,"color":"green"},{"text":"!","color":"green"}]
