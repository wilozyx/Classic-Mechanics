scoreboard players set CM.global CM_OldStrongholdLoot 2

tellraw @s ["",{"text":"\u261e ","color":"green"},{"text":"Enabled old stronghold chest loot (R1.4.6)","bold":true,"color":"green"},{"text":"!","color":"green"}]
