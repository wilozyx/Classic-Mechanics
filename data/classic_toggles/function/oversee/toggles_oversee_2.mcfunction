...
tellraw @s ["",{"text":"[","color":"gold","clickEvent":{"action":"run_command","value":"/function classic_toggles:oversee/toggles_oversee_1"},"hoverEvent":{"action":"show_text","value":[{"text":">Click to display previous page","color":"#F2D622","bold":true}]}},{"text":"\u2190 Previous page","color":"yellow","clickEvent":{"action":"run_command","value":"/function classic_toggles:oversee/toggles_oversee_1"},"hoverEvent":{"action":"show_text","value":[{"text":">Click to display previous page","color":"#F2D622","bold":true}]}},{"text":"]","color":"gold","clickEvent":{"action":"run_command","value":"/function classic_toggles:oversee/toggles_oversee_1"},"hoverEvent":{"action":"show_text","value":[{"text":">Click to display previous page","color":"#F2D622","bold":true}]}},{"text":" - ","color":"gold"},{"text":"[","color":"gold","clickEvent":{"action":"run_command","value":"/function classic_toggles:oversee/toggles_oversee_3"},"hoverEvent":{"action":"show_text","value":[{"text":">Click to display next page","color":"#F2D622","bold":true}]}},{"text":"Next page \u2192","color":"yellow","clickEvent":{"action":"run_command","value":"/function classic_toggles:oversee/toggles_oversee_3"},"hoverEvent":{"action":"show_text","value":[{"text":">Click to display next page","color":"#F2D622","bold":true}]}},{"text":"]","color":"gold","clickEvent":{"action":"run_command","value":"/function classic_toggles:oversee/toggles_oversee_3"},"hoverEvent":{"action":"show_text","value":[{"text":">Click to display next page","color":"#F2D622","bold":true}]}},{"text":"\n "}]
