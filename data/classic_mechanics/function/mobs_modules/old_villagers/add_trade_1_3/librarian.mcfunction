...
function classic_mechanics:mobs_modules/old_villagers/add_trade_1_3/get_tradeid_8
...
execute if score @s CM_OV_TradeID matches 5 run function classic_mechanics:mobs_modules/old_villagers/trades/paper_old
execute if score @s CM_OV_TradeID matches 6 run function classic_mechanics:mobs_modules/old_villagers/trades/books_old
