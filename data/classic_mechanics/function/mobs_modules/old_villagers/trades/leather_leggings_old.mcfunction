tag @s add CM.OV.leather_leggings
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald2_3
data modify storage classic_mechanics:old_villagers data.buy set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/leather_leggings
