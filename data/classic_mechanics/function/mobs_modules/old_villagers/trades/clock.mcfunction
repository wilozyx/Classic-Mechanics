tag @s add CM.OV.clock
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald10_12
data modify storage classic_mechanics:old_villagers data.buy set from entity @s ArmorItems[3]
loot replace entity @s armor.head loot classic_mechanics:old_trades/clock
