tag @s add CM.OV.enchanted_iron_shovel
loot replace entity @s armor.head loot classic_mechanics:old_trades/iron_shovel
data modify storage classic_mechanics:old_villagers data.buy set from entity @s ArmorItems[3]
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald5_7
data modify storage classic_mechanics:old_villagers data.buy2 set from entity @s ArmorItems[3]
loot replace entity @s armor.head loot classic_mechanics:old_trades/enchanted_iron_shovel
