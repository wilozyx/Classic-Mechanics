tag @s add CM.OV.enchanted_fishing_rod
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald7_8
data modify storage classic_mechanics:old_villagers data.buy set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/enchanted_fishing_rod
