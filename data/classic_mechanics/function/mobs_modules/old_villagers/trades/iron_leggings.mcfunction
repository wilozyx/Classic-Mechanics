tag @s add CM.OV.iron_leggings
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald8_9
data modify storage classic_mechanics:old_villagers data.buy set from entity @s ArmorItems[3]
loot replace entity @s armor.head loot classic_mechanics:old_trades/iron_leggings
