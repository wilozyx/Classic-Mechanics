tag @s add CM.OV.enchanted_diamond_chestplate
loot replace entity @s armor.head loot classic_mechanics:old_trades/diamond_chestplate
data modify storage classic_mechanics:old_villagers data.buy set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald16_19
data modify storage classic_mechanics:old_villagers data.buy2 set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/enchanted_diamond_chestplate
