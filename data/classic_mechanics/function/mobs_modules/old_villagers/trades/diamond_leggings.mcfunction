tag @s add CM.OV.diamond_leggings
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald11_13
data modify storage classic_mechanics:old_villagers data.buy set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/diamond_leggings
