tag @s add CM.OV.ocean_map
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald12_20
...
loot replace entity @s armor.head loot classic_mechanics:old_trades/ocean_map
