tag @s add CM.OV.cooked_cod
loot replace entity @s armor.head loot classic_mechanics:old_trades/cod
...
loot replace entity @s armor.head loot classic_mechanics:old_trades/cooked_cod
