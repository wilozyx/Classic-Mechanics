tag @s add CM.OV.enchanted_diamond_pickaxe
loot replace entity @s armor.head loot classic_mechanics:old_trades/diamond_pickaxe
data modify storage classic_mechanics:old_villagers data.buy set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald12_15
data modify storage classic_mechanics:old_villagers data.buy2 set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/enchanted_diamond_pickaxe
