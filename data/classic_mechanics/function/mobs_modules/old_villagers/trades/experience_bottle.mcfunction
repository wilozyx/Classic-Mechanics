tag @s add CM.OV.experience_bottle
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald3_11
data modify storage classic_mechanics:old_villagers data.buy set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/experience_bottle
