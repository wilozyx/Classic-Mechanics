tag @s add CM.OV.diamond_shovel
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald7
data modify storage classic_mechanics:old_villagers data.buy set from entity @s ArmorItems[3]
loot replace entity @s armor.head loot classic_mechanics:old_trades/diamond_shovel
