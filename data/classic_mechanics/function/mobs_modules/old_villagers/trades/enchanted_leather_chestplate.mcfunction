tag @s add CM.OV.enchanted_leather_chestplate
loot replace entity @s armor.head loot classic_mechanics:old_trades/leather_chestplate
data modify storage classic_mechanics:old_villagers data.buy set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald7_12
data modify storage classic_mechanics:old_villagers data.buy2 set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/enchanted_leather_chestplate
