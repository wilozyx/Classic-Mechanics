tag @s add CM.OV.cooked_chicken
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald6_8
data modify storage classic_mechanics:old_villagers data.buy set from entity @s ArmorItems[3]
loot replace entity @s armor.head loot classic_mechanics:old_trades/cooked_chicken
