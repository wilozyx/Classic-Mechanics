tag @s add CM.OV.saddle
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald8_10
data modify storage classic_mechanics:old_villagers data.buy set from entity @s ArmorItems[3]
loot replace entity @s armor.head loot classic_mechanics:old_trades/saddle
