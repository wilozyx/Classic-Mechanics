tag @s add CM.OV.chainmail_chestplate
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald11_15
data modify storage classic_mechanics:old_villagers data.buy set from entity @s ArmorItems[3]
loot replace entity @s armor.head loot classic_mechanics:old_trades/chainmail_chestplate
