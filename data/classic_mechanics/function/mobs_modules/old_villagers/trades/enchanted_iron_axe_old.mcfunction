tag @s add CM.OV.enchanted_iron_axe
loot replace entity @s armor.head loot classic_mechanics:old_trades/iron_axe
...
loot replace entity @s armor.head loot classic_mechanics:old_trades/enchanted_iron_axe
