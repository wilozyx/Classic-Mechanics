tag @s add CM.OV.iron_helmet
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald4_6
data modify storage classic_mechanics:old_villagers data.buy set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/iron_helmet
