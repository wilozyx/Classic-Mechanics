tag @s add CM.OV.enchanted_diamond_sword
loot replace entity @s armor.head loot classic_mechanics:old_trades/diamond_sword
...
loot replace entity @s armor.head loot classic_mechanics:old_trades/enchanted_diamond_sword
