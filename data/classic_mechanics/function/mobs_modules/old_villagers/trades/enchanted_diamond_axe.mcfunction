tag @s add CM.OV.enchanted_diamond_axe
loot replace entity @s armor.head loot classic_mechanics:old_trades/diamond_axe
data modify storage classic_mechanics:old_villagers data.buy set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/emerald9_12
data modify storage classic_mechanics:old_villagers data.buy2 set from entity @s equipment.head
loot replace entity @s armor.head loot classic_mechanics:old_trades/enchanted_diamond_axe
