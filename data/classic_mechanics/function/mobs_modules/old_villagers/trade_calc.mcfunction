...
$execute if score CM.global CM_OldVillagers matches 6 run function classic_mechanics:mobs_modules/old_villagers/add_trade_1_8/$(profid)
$execute if score CM.global CM_OldVillagers matches 7 run function classic_mechanics:mobs_modules/old_villagers/add_trade_1_9/$(profid)
$execute if score CM.global CM_OldVillagers matches 8 run function classic_mechanics:mobs_modules/old_villagers/add_trade_1_11/$(profid)
