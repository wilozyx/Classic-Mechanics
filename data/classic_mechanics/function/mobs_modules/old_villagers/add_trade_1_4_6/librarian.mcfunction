...
function classic_mechanics:mobs_modules/old_villagers/add_trade_1_4_6/get_tradeid_9
...
execute if score @s CM_OV_TradeID matches 9 run function classic_mechanics:mobs_modules/old_villagers/trades/enchanted_book
