...
# -> advance page sound
data modify storage classic_mechanics:options sounds_page_advance set value "minecraft:entity.enderman.teleport"
...
# -> regress page sound
data modify storage classic_mechanics:options sounds_page_regress set value "minecraft:entity.enderman.teleport"
...
# -> enable message
tellraw @s [{"text":"[Set main menu sound to 'ender']","color":"green","bold":true}]
