...
# -> main menu sound
data modify storage classic_mechanics:options sounds_main_menu set value "minecraft:block.anvil.place"
...
# -> enable message
tellraw @s [{"text":"[Set main menu sound to 'anvil']","color":"green","bold":true}]
