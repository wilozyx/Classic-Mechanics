...
# -> enable module sound
data modify storage classic_mechanics:options sounds_enable_module set value "minecraft:block.amethyst_block.resonate"
...
data modify storage classic_mechanics:options sounds_disable_module set value "minecraft:block.amethyst_block.resonate"
...
# -> enable message
tellraw @s [{"text":"[Set the module toggle sounds to 'chime']","color":"green","bold":true}]
