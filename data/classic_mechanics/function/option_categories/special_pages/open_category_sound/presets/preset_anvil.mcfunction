...
# -> open category sound
data modify storage classic_mechanics:options sounds_open_category set value "minecraft:block.anvil.place"
...
# -> enable message
tellraw @s [{"text":"[Set the open category sound to 'anvil']","color":"green","bold":true}]
