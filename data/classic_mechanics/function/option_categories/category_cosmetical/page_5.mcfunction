...
data merge storage classic_mechanics:options \
    {\
        ...
        "disable_structure":"/function classic_toggles:toggles/disable_with_data/constant_love_hearts",\
        \
        "extension":"\n"\
    }
...
data merge storage classic_mechanics:options \
    {\
        ...
        "module_desc":"Prior to B1.0, items did not have any names, or tooltips! This module removes the tooltips from items and their names, returning the pre-B1.0 look of items; item names also dont show up above the hotbar when equipping them on your hand!\n\nNOTE:\nItems that have been affected by this module cannot be reverted when it's disabled!",\
        \
        "module_version":"I0.31-B1.0",\
        \
        "enable_structure":"/function classic_toggles:toggles/enable_generic/enable_module_1 {\\\"score\\\":\\\"CM_NoItemNames\\\",\\\"function1\\\":\\\"classic_mechanics:multipurpose/module_functionality/enable_global_item_modif\\\",\\\"module\\\":\\\"no item names\\\",\\\"page\\\":\\\"category_cosmetical/page_5\\\"}",\
        "disable_structure":"/function classic_toggles:toggles/disable_generic/disable_module_1 {\\\"score\\\":\\\"CM_NoItemNames\\\",\\\"function1\\\":\\\"classic_mechanics:main/empty\\\",\\\"module\\\":\\\"no item names\\\",\\\"page\\\":\\\"category_cosmetical/page_5\\\"}",\
        \
        "extension":"\n"\
    }
function classic_mechanics:option_categories/special_general/page_contents/page_module_simple with storage classic_mechanics:options
