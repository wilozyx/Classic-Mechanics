...
# -> Remove food item
execute if score @s CM_HandDetect matches 1 unless items entity @s weapon.mainhand beetroot_soup run item modify entity @s weapon.mainhand classic_mechanics:old_food/old_food_used
execute if score @s CM_HandDetect matches 2 unless items entity @s weapon.mainhand beetroot_soup run item modify entity @s weapon.offhand classic_mechanics:old_food/old_food_used

# -> If the eaten item is beetroot soup, replace it with a bowl
execute if score @s CM_HandDetect matches 1 if items entity @s weapon.mainhand beetroot_soup run item replace entity @s weapon.mainhand with bowl
execute if score @s CM_HandDetect matches 2 if items entity @s weapon.mainhand beetroot_soup run item replace entity @s weapon.offhand with bowl