...
execute if score @s CM_BonemealConditional matches 2 run function classic_mechanics:mechanics_modules/old_bonemeal/saplings/birch/birch_flower_placement