...
# 1 1 Corner
execute store result score @s CM_BonemealTreeConditional run fill ~ ~ ~ ~1 ~ ~1 decorated_pot[cracked=true] replace spruce_sapling
fill ~ ~ ~ ~1 ~ ~1 spruce_sapling replace decorated_pot[cracked=true]
...
execute if score @s CM_BonemealConditional matches 1 run place feature mega_spruce
execute if score @s CM_BonemealConditional matches 1 if block ~ ~ ~ air run fill ~ ~ ~ ~1 ~ ~1 spruce_sapling
...
execute if score @s CM_BonemealConditional matches 2 positioned ~ ~ ~-1 run place feature mega_spruce
execute if score @s CM_BonemealConditional matches 2 if block ~ ~ ~ air run fill ~ ~ ~ ~1 ~ ~-1 spruce_sapling
...
execute if score @s CM_BonemealConditional matches 3 positioned ~-1 ~ ~ run place feature mega_spruce
execute if score @s CM_BonemealConditional matches 3 if block ~ ~ ~ air run fill ~ ~ ~ ~-1 ~ ~1 spruce_sapling
...
execute if score @s CM_BonemealConditional matches 4 positioned ~-1 ~ ~-1 run place feature mega_spruce
execute if score @s CM_BonemealConditional matches 4 if block ~ ~ ~ air run fill ~ ~ ~ ~-1 ~ ~-1 spruce_sapling
