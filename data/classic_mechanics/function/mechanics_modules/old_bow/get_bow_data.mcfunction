...
# -> Set arrow_slot_id if player is in creative
execute as @s[gamemode=creative] run \
    data merge storage classic_mechanics:old_bow {arrow_slot_id:"9",arrow_slot:"inventory.0"}
