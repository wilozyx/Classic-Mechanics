# -> Reset adv trigger
advancement revoke @s only classic_mechanics:old_tilling/seed_tilling_ray

# -> Reset scores
scoreboard players set @s CM_IsLookingAtGrass 0
...
execute anchored eyes positioned ^ ^ ^ anchored feet run \
    function classic_mechanics:mechanics_modules/old_tilling/seed_tilling_ray_travel
