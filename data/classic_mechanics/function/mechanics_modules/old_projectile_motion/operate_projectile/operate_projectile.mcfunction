...
execute store result entity @s Motion[0] double 0.00341 run scoreboard players get @s CM_ProjEndX
execute store result entity @s Motion[1] double 0.00341 run scoreboard players get @s CM_ProjEndY
execute store result entity @s Motion[2] double 0.00341 run scoreboard players get @s CM_ProjEndZ
