# -> Reset advancement
advancement revoke @s only classic_mechanics:item_modifications_affect_containers/open_brewing_stand
...
execute anchored eyes positioned ^ ^ ^ anchored feet run \
    function classic_mechanics:multipurpose/module_functionality/item_modifications_affect_containers/open_brewing_stand/container_ray_travel
