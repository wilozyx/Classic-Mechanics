...
execute positioned ~ ~1 ~ if block ~ ~ ~ nether_portal run function classic_mechanics:blocks_modules/no_nether_portal_creation/seemless_portal_creation/portal_fill_x
execute positioned ~ ~-1 ~ if block ~ ~ ~ nether_portal run function classic_mechanics:blocks_modules/no_nether_portal_creation/seemless_portal_creation/portal_fill_x
execute positioned ~1 ~ ~ if block ~ ~ ~ nether_portal run function classic_mechanics:blocks_modules/no_nether_portal_creation/seemless_portal_creation/portal_fill_x
execute positioned ~-1 ~ ~ if block ~ ~ ~ nether_portal run function classic_mechanics:blocks_modules/no_nether_portal_creation/seemless_portal_creation/portal_fill_x
